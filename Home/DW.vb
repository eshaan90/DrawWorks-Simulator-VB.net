...
Public Class DW
    ...
    Private move_obj As New movement
    ...
    Public rf As Integer = 0
    Public flr As Integer = 0
    ...
    'BELOW ALL FUNCTIONS ARE FOR THE DW AUTO MODE GROUPBOX COMMANDS
    ...
    Private Sub Button17_Click(sender As Object, e As EventArgs) Handles Button17.Click
        move_obj.up_movement()
    End Sub

    ''Manual Mode Down Button
    Private Sub Button18_Click(sender As Object, e As EventArgs) Handles Button18.Click
        move_obj.down_movement()
    End Sub
    ...
    'BELOW ALL FUNCTIONS ARE FOR THE FAULT SIMULATION GROUPBOX COMMANDS
    ...
    'DW LOW HPU PRESSURE BUTTON ACTIVATED
    ...
    'DW HPU PRESSURE NORMAL BUTTON ACTIVATED
